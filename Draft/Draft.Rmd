...
```{r mbgraphics-indices, fig.height=3, fig.cap="(ref:mbgraphics-indices)"}
```
```{r guided-spline2d, include=FALSE}
```
```{r guided-spline2d-plot, fig.height=3, fig.cap="(ref:guided-spline2d-plot)"}
```
```{r guided-dcor2d, include=FALSE}
```
```{r guided-dcor2d-plot, fig.height=3, fig.cap="(ref:guided-dcor2d-plot)"}
```
...
```{r gminus2-box, fig.height=3}
```

```{r guided-dcor2d-no-gminus2, include=FALSE}
```
```{r guided-dcor2d-plot-no-gminus2, fig.height=3, fig.cap="(ref:guided-dcor2d-plot)"}
```
