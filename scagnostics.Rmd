...
\textcolor{red}{Updated the plot, makes it look like skinny, 1-convex should be better index to optimise, however in practice this is not the case, probably because TIC is less sensitive to fluctuations, making it more robust against getting stuck in local maxima.}
