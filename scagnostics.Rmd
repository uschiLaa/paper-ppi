...
FIXME yes/no labels appear to be inverted?
...
getIdx <- function(dataT, size, structured){
  ...
  lapply(c(skinny, stringy, convex, micidx, ticidx, dcor2D, splines2D), sort)
  res <- tableTemp() %>%
...
knitr::kable(res,  caption = "Summary of index values.", digits=2) 
```
