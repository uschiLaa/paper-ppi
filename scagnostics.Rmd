...
Three data simulations are used for examining the behaviour of the index functions. Each generates special structure in two variables, and the remaining variables are noise. 

- structure to be found is 2D, scagnostics could find them, point is PP would find if in a combination of variables
- structure is 2D, noise variables are different. 
...
we use three types of simulated data sets based on different underlying distributions, and with different built-in features. They are defined in $n=6$ dimensions with $p$ randomly selected points $x_i, i = 1,..,n$ according to:
