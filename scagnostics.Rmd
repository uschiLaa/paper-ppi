...
quartz()
animate_xy(pipeResc, guided_tour(mineIndex("TIC"), search_f = tourr:::search_better,
                                     cooling=1, alpha = 0.5, max.tries = 5000))
animate_xy(pipeResc, guided_tour(holes, search_f = tourr:::search_better,
                                     cooling=1, alpha = 0.5, max.tries = 5000))
```
