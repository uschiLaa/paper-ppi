...
Compare typical index values over the two tour paths. Notation: path1 / 2 labels tour from V1-V2 to V3-V4 / V5-V6.

```{r indexDist, fig.width=6, fig.height=7, fig.cap="Short tour paths with scagnostics computed on projections. Most of the indices exhibit sharp jumps in scagnostic value."}
