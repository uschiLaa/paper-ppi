...
We next compare the various indexvalues for three views: V1 vs V2, V5 vs V6 and V1 vs V6 (capturing differences from the different distribution in V6).
...
pipeTour <- save_history(pipeResc,
                         guided_tour(mineIndex("TIC"), n=10, cooling = 0.8), start = p58)
