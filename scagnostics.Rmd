...
```{r pipeFirstRun,fig.width=6, fig.height=7, fig.cap="Guided tour optimising MIC index for Pipe 1000 dataset.", echo=FALSE}
...
### Finding sine waves
```{r findsine, fig.width=6, fig.height=7, fig.cap="Guided tour optimising TIC index for Sine 1000 dataset.", echo=FALSE}
set.seed(2018)
