...
In the following we work with rescaled data where each direction has been centered and scaled to have variance equal to 1. This is neccessary for standard indices to be well defined, but does not impact the results when using the newly considered index functions.
