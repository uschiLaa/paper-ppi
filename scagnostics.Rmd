...
Projection pursuit is typically 
*** Explanation of tour algorithm and projection pursuit and software

*** Explanation of scagnostics and software

The projectionpursuitindex, a function of all possible projections
of the data, invariablyhas many "hills and valleys" and "knife-edgeridges"because of
the varying shape of underlyingdensity estimates from one projectionto the next.

The paper is accompanied by the R package "binostics" available on CRAN, and new indices have been implemented in the "tourr" package. 
