---
title: An investigation into using scagnostics interesting projections of high-dimensional data
...
A large number of projection pursuit indices have been developed [@f87] [@CBC92] [@Lee05] [@AHC02] [@CEM:CEM2568] [@JS87] [@5508437]. Many of these are developed to detect departure from multivariate normal, which includes clusters or outliers, or nonlinearity. Some have been developed to detect separations between known groups. However, if one wants to find complicated co-dependence between parameters there are no options.
...
same value. Maybe some need to be normalised by n
-->
