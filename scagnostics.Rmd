...
res_all <- bind_cols(resp, resi, ress) %>%
  ...
  mutate(index = fct_relevel(index, "convex", "skinny", "stringy", "dcor2D", "splines2D", "MICe", "TICe", "holes")) %>%
  arrange(index) %>%
  mutate(index = c("convex", "", "skinny", "", "stringy", "", "dcor2D", "", "splines2D", "", "MICe", "", "TICe", "", "holes", ""))
